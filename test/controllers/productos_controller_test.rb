...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference("Producto.count") do
      post productos_url, params: { producto: { img: @producto.img, marca: @producto.marca, nombre: @producto.nombre, precio: @producto.precio, tipo: @producto.tipo } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { img: @producto.img, marca: @producto.marca, nombre: @producto.nombre, precio: @producto.precio, tipo: @producto.tipo } }
